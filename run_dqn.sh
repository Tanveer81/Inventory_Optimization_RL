...
python dqn_date.py --experiment_name dqn_date_ep_100000_hlyr16_8_lstm_8_dmnd_12_1_gma_.999_lr_1e-5_b64_Q115 --hidden_layers 16 8 --hidden_dim_lstm 8 --past_demand 12 --demand_embedding 1 --test True --material_name $material --hack_test True
python dqn_date.py --experiment_name dqn_date_ep_100000_hlyr16_8_lstm_8_dmnd_12_1_gma_.999_lr_1e-5_b64_Q115 --hidden_layers 16 8 --hidden_dim_lstm 8 --past_demand 12 --demand_embedding 1 --test True --evaluate_train True --material_name $material --hack_test True

python dqn_date.py --experiment_name dqn_date_ep_100000_hlyr16_8_lstm_8_dmnd_12_1_gma_.999_lr_1e-8_lrn_evry16_b64_Q115 --hidden_layers 16 8 --hidden_dim_lstm 8 --past_demand 12 --demand_embedding 1 --test True --material_name $material --hack_test True
python dqn_date.py --experiment_name dqn_date_ep_100000_hlyr16_8_lstm_8_dmnd_12_1_gma_.999_lr_1e-8_lrn_evry16_b64_Q115 --hidden_layers 16 8 --hidden_dim_lstm 8 --past_demand 12 --demand_embedding 1 --test True --evaluate_train True --material_name $material --hack_test True

python dqn_date.py --experiment_name dqn_date_ep_100000_hlyr512_256_128_64_lstm_128_dmnd_12_6_gamma_.999_lr_1e-8_learn_every_16_batch_128_Q115 --hidden_layers 512 256 128 64 --hidden_dim_lstm 128 --past_demand 12 --demand_embedding 6 --test True --material_name $material --hack_test True
python dqn_date.py --experiment_name dqn_date_ep_100000_hlyr512_256_128_64_lstm_128_dmnd_12_6_gamma_.999_lr_1e-8_learn_every_16_batch_128_Q115 --hidden_layers 512 256 128 64 --hidden_dim_lstm 128 --past_demand 12 --demand_embedding 6 --test True --evaluate_train True --material_name $material --hack_test True
